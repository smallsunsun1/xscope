...
- Keep Go for Kubernetes CRD types, cluster-agent and controller-runtime Operator. Rust owns business APIs, identity, billing and Pingora gateway. Use SeaORM for business database access.
